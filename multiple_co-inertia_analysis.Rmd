...
mcoi_set<-c("Nerita_plicata_CO1","Nerita_albicilla_CO1","Tripneustes_gratilla_CO1","Naso_unicornis_CR","Dascyllus_aruanus_CYB","Dascyllus_trimaculatus_CR","Acanthaster_planci_CO1","Panulirus_penicillatus_CO1","Stenella_longirostris_CYB","Stenella_longirostris_CR","Scarus_psittacus_CR","Diadema_savignyi_A68","Cephalopholis_argus_CYB", "Naso_brevirostris_CR")

#and a set of Veron's regions from which all have been sampled (see ipdb2RegionSumaries__ET.R)
regions<-c("Indian Ocean", "Coral Triangle","Central Pacific","French Polynesia")
...
# display %PCA
nsamp<-gsl_ktab$blo
col = c("red","purple","blue","deepskyblue4")
