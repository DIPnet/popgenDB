...
#ipdb<-ipdb[!duplicated(ipdb),]  #remove duplicates if you need to in the future
...
for(r in c("sample","meow_ecoregion", "meow_prov_name", "meow_rlm_name","fn100id", "fn500id","EEZ_country")){
  ...
  save(divstats,file=file.path("./For_NESCent",r,paste("DIPnet_stats_032415_ABGD_",r,".Rdata",sep="")))
