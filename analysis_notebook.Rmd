...
ggsave(phist_medians,file="./output/phist_medians4.pdf", width=7, height=7, units="in")
ggsave(phist_violins,file="./output/phist_violins3.pdf", width=7, height=7, units="in")

length(which(extracted_Fst2$West_Indian==0))
...
length(which(extracted_Fst_melt$variable=="Simulated"))