...
WriteXLS(amovastats,ExcelFileName=file.path(amova_ts_path,"PhiST_TradSpec_table_amova_output.Rdata.xlsx"),row.names = T)
#save(amova_list,file=file.path(amova_ts_path,"FST_TradSpec_raw_amova_output.Rdata"))
save(amovastats,file=file.path(amova_ts_path,"Phi_TradSpec_table_amova_output.Rdata"))
```
...
load(file=file.path(amova_ts_path,"PHIST_TradSpec_table_amova_output.Rdata"))
...
importance_df2<-importance_df2[,-which(names(importance_df2)=="VeronDivis")]
