...
#go through best_hypotheses and cull to the simplest hypothesis in case of ties.
```
...
write.csv(term.vars,file="./output/dbRDA_term_vars_PHIST_022618.csv")
write.csv(term.pvals,file="./output/dbRDA_term_pvals_PHIST_022618.csv")

 save(all.gsl.rda,file="./output/multibarrier_dbRDA_PHIST_022618.Rdata")
  
write.csv(stats, "./output/multibarrier_dbRDA_PHIST_022618.csv")
...
colMeans(extracted_Fst2, na.rm=T)
...
ggplot(data=extracted_Fst_melt, aes(x=variable,y=value)) + geom_violin() + stat_summary(fun.data = n_fun, geom = "text") + geom_jitter() + ylab(expression(Phi[ST])) + xlab("Barrier")
