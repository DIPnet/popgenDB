...
for(gsl in esu_loci){ #gsl<-"Linckia_laevigata_CO1" "Tridacna_crocea_CO1" "Lutjanus_kasmira_CYB" "Acanthaster_planci_CO1"
  ...
  for(j in 1:16){
    ...
    while(length(rand.deltas) < 1000) {
      ...
      explained.rand<-gdm.no.barrier$explained
...
write.csv(stats,"./output/GDM_output_PhiST_1000reps.csv")
write.csv(barrier_ratios, "./output/GDM_PhiST_1000reps_barriers.csv")
```
