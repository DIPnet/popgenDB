...
```{r dbRDA}
#get diffstats for just ip localities
#diffstats<-pairwise.structure.mtDNA.db(ipdb=ipdb_ip, gdist = "PhiST", minseqs = 6, minsamps = 3, mintotalseqs = 0, nrep = 0, num.cores = 2, ABGD = F, regionalization = "sample")

#save(diffstats,file="DIPnet_structure_sample_PhiST_030918.Rdata")


# read in the Fst/PhiSt table 
load("DIPnet_structure_sample_PhiST_031818.Rdata")
...
ibdplots<-marrangeGrob(plotlist, nrow=2,ncol=2)
ggsave("./output/ibdplots_030818.pdf",ibdplots)
