...
write.csv(term.vars,file="./output/dbRDA_term_vars_PHIST_013018.csv")
write.csv(term.pvals,file="./output/dbRDA_term_pvals_PHIST_013018.csv")

 save(all.gsl.rda,file="./output/multibarrier_dbRDA_PHIST_013018.Rdata")
  
write.csv(stats, "./output/multibarrier_dbRDA_PHIST_013018.csv")
...
ggplot(data=extracted_Fst_melt, aes(x=variable,y=value)) + geom_violin() + stat_summary(fun.data = n_fun, geom = "text") + geom_jitter() + ylab(expression(Phi[ST])) + xlab("")
